function Game() {
    // Elements
	document.getElementById("start-game").style.backgroundColor = "black";
    ...
    var clickHandler = function() {
        ...
        board[pos[0]][pos[1]] = nextPlayer() == 'x' ? 1 : 0;     
        if(checkWinner()) {
            gameWon();
        } 
    ...
    var gameWon = function() {
        ...
        gameMessages.className = window.alert(nextPlayer() + ' win!');
    ...
    var gameDraw = function() {
        gameMessages.className = window.alert("Flat!");
        clearEvents();
    }
